...
const LeftMenu: React.FC = () => {
  ...
  useEffect(() => {
    const isMaxLengthSettingEnabled =
      adminSettingsState?.adminSettings?.navigationSettingEnabled;

    if (isMaxLengthSettingEnabled === true) setIsMaxLengthVisible(true);
      ...
      >
        ...
        showAdminSidebar?.controlPanelUserGroups?.isEnabled == false ? (
          ...
          <li className="nav-item subMenu">
            ...
            {showAdminSidebar?.controlPanelUserGroups?.isEnabled == true &&
            ...
            {showAdminSidebar?.controlPanelUserPermission?.isEnabled == true &&
              adminSettingsState.adminSettings.userPermissionEnabled && (
                <Link
                  className={`subMenu-item nav-link  ${openMenu && "d-block"}`}
                  to={`/user-permission`}
            ...
            {showAdminSidebar?.controlPanelNavigationSetting?.isEnabled ==
              true && (
              <Link
                className={`subMenu-item nav-link  ${openMenu && "d-block"}`}
                to={`/setting`}
